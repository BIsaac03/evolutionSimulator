...
#        self.A6wB4 = A1[3]
    ...
    def determineMovement(self, relativePlantX, relativePlantY, currentSpeed, currentDirection):
        ...
        speedChange = (C1 * self.C1wO1 + C2 * self.C2wO1 + C3 * self.C3wO1 + C4 * self.C4wO1)
        directionChange = (C1 * self.C1wO2 + C2 * self.C2wO2 + C3 * self.C3wO2 + C4 * self.C4wO2)
    ...
    def getWeights(self):
        ...
        A3 = [self.A3wB1, self.A3wB2, self.A3wB3, self.A3wB4]
        A4 = [self.A4wB1, self.A4wB2, self.A4wB3, self.A4wB4]
